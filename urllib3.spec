...
%prep
%setup -q -n urllib3-1.25.8
cd %{_builddir}/urllib3-1.25.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579657191
...
cp %{_builddir}/urllib3-1.25.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/urllib3/a9d3f17b9e2494f5933ad68688e1c4691b86ba48
