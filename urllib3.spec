...
Source0  : https://files.pythonhosted.org/packages/19/80/b2a19b372f16bc846fd156de8d9b3a9b1092aef1f1963d800b0f8c76a67a/urllib3-1.26.1.tar.gz
...
%prep
%setup -q -n urllib3-1.26.1
cd %{_builddir}/urllib3-1.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605195842
...
cp %{_builddir}/urllib3-1.26.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
