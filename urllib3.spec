...
Source0  : https://files.pythonhosted.org/packages/4f/5a/597ef5911cb8919efe4d86206aa8b2658616d676a7088f0825ca08bd7cb8/urllib3-1.26.6.tar.gz
...
%prep
%setup -q -n urllib3-1.26.6
cd %{_builddir}/urllib3-1.26.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631502672
...
cp %{_builddir}/urllib3-1.26.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
