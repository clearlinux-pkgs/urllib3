...
%prep
%setup -q -n urllib3-1.25.10
cd %{_builddir}/urllib3-1.25.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595456611
...
cp %{_builddir}/urllib3-1.25.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/urllib3/a9d3f17b9e2494f5933ad68688e1c4691b86ba48
