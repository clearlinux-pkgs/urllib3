...
Source0  : https://files.pythonhosted.org/packages/d7/8d/7ee68c6b48e1ec8d41198f694ecdc15f7596356f2ff8e6b1420300cf5db3/urllib3-1.26.3.tar.gz
...
%prep
%setup -q -n urllib3-1.26.3
cd %{_builddir}/urllib3-1.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611767480
...
cp %{_builddir}/urllib3-1.26.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
