...
Source0  : https://files.pythonhosted.org/packages/94/40/c396b5b212533716949a4d295f91a4c100d51ba95ea9e2d96b6b0517e5a5/urllib3-1.26.5.tar.gz
...
%prep
%setup -q -n urllib3-1.26.5
cd %{_builddir}/urllib3-1.26.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622066986
...
cp %{_builddir}/urllib3-1.26.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
